...
public class DruidConfiguration {
    ...
    @Value("{spring.datasource.druid.whileList}")
    private String druidWhiteList;

    @Value("{spring.datasource.druid.blackList")
    ...
    @Value("{spring.datasource.druid.isResetData}")
    private String druidIsResetData;
